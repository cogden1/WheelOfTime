package net.cogden1.wheeloftime.world.structure.structures;
...
public class SpineStructure extends Structure<NoFeatureConfig> {
    public SpineStructure(Codec<NoFeatureConfig> p_i231997_1_) {
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return SpineStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart<NoFeatureConfig> {
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator,
            ...
            LogManager.getLogger().log(Level.DEBUG, "Spine at " +
