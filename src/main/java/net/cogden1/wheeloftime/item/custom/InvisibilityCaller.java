...
public class InvisibilityCaller extends Item{

    public InvisibilityCaller(Properties properties) {
        super(properties);
    }
    ...
    {
            giveEntityInvisibility(playerEntity, 20000);
    }

    public static void giveEntityInvisibility(PlayerEntity playerEntity,int tick)
    {
        playerEntity.addEffect(new EffectInstance(Effects.INVISIBILITY,tick));
    }
