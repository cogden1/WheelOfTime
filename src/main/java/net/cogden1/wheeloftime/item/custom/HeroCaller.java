...
public class HeroCaller extends Item{

    public HeroCaller(Properties properties) {
        super(properties);
    }
    ...
    {
            giveEntityHero(playerEntity, 20000, 5);
    }

    public static void giveEntityHero(PlayerEntity playerEntity,int tick,int level)
    {
        playerEntity.addEffect(new EffectInstance(Effects.HERO_OF_THE_VILLAGE,tick,level));
    }
