...
public class JumpCaller2 extends Item{

    public JumpCaller2(Properties properties) {
        super(properties);
    }
    ...
    {
            giveEntityJump(playerEntity, 2400, 2);
    }

    public static void giveEntityJump(PlayerEntity playerEntity,int tick,int level)
    {
        playerEntity.addEffect(new EffectInstance(Effects.JUMP,tick,level));
    }
