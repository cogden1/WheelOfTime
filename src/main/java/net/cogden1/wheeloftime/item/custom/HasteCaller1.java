...
public class HasteCaller1 extends Item{

    public HasteCaller1(Properties properties) {
        super(properties);
    }
    ...
    {
            giveEntityHaste(playerEntity, 2200, 1);
    }

    public static void giveEntityHaste(PlayerEntity playerEntity,int tick,int level)
    {
        playerEntity.addEffect(new EffectInstance(Effects.DIG_SPEED,tick,level));
    }
